...
class TestExpandedHardlineFloor:
    @pytest.mark.parametrize(
        ...
        (
            ...
            "lvremove -y vg/data",
            "lvremove --select=lv_name=test -y",
            "lvremove -Slv_name=test -y",
            "vgremove vg0",
            "pvremove /dev/sdb",
            ...
            "echo payload > /dev/./sda",
            "echo payload > /dev/mapper/../sda",
            "echo payload >| /dev/sda",
            "echo payload 1>|/dev/sda",
            "find -H /home -delete",
            ...
            "find -H /home -exec rm -rf {} +",
            "find -D search /home -exec rm -rf {} +",
            'find "$HOME/" -delete',
            'find "${HOME}/" -delete',
            "find ~/ -delete",
            "find /etc/?* -delete",
            ...
            "find /home/[^x]* -delete",
            "find / -delete -name safe",
            "find / -path '/*' -delete",
            "find / -regex '/.*' -delete",
            "find / -path '/home/*' -delete",
            "find /etc -false -o -delete",
            "find /etc ! -false -delete",
            "zfs destroy -f -r tank/home",
            "zfs destroy -f -R tank/home",
            "command wipefs -a /dev/sda",
            "command -p wipefs -a /dev/nvme0",
            "sudo -u root blkdiscard /dev/sda",
            "env -i sgdisk --zap-all /dev/sda",
            "sudo --user root wipefs -a /dev/sda",
            "env -u SAFE find /etc -delete",
            "sudo -u root zpool destroy tank",
            "env -i zfs destroy -r tank/home",
            "sudo --user=root lvremove -y vg/data",
            "env --unset=SAFE pvremove /dev/sdb",
            "sudo -D /tmp blkdiscard /dev/sda",
            "sudo --chdir /tmp wipefs -a /dev/sda",
            "sudo -nD /tmp blkdiscard /dev/sda",
            "sudo -R / zpool destroy tank",
            "sudo --chroot / lvremove -y vg/data",
            "env --chdir /tmp pvremove /dev/sdb",
            "env -iC /tmp wipefs -a /dev/sda",
            "find / -name '[!.]*' -delete",
            "find -E / -delete",
            "find -d / -delete",
            "find -X / -delete",
            ...
            "nice -n 5 dd if=/dev/zero of=/dev/sda",
            "nice --adjustment=-5 dd if=/dev/zero of=/dev/sda",
            "ionice -c 3 dd if=/dev/zero of=/dev/sda",
            "ionice -c3 -n7 dd if=/dev/zero of=/dev/sda",
            "timeout 5 dd if=/dev/zero of=/dev/sda",
            "timeout --signal KILL 5 mkfs.ext4 /dev/sda",
            "time -p mkfs.ext4 /dev/sda",
            "time --format '%E' dd if=/dev/zero of=/dev/sda",
            "stdbuf -o L dd if=/dev/zero of=/dev/sda",
            "stdbuf --output=L mkfs.ext4 /dev/sda",
            "if true; then dd if=/dev/zero of=/dev/sda; fi",
            "while true; do mkfs.ext4 /dev/sda; done",
            "false || { if true; then wipefs -a /dev/sda; fi; }",
            "/sbin/reboot",
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            "cp --help /dev/sda",
            "nice dd if=/dev/sda of=/tmp/disk.img",
            "ionice -c 3 dd if=/dev/sda of=/tmp/disk.img",
            "timeout 5 dd if=/dev/sda of=/tmp/disk.img",
            "time -p dd if=/dev/sda of=/tmp/disk.img",
            "stdbuf -o L dd if=/dev/sda of=/tmp/disk.img",
            "if true; then dd if=/dev/sda of=/tmp/disk.img; fi",
            "while true; do echo /dev/sda; done",
            ...
            "wipefs -an /dev/sda",
            "blkdiscard -n /dev/sda",
            "blkdiscard -nv /dev/sda",
            "blkdiscard --dry-run /dev/sda",
            "timeout --help 5 reboot",
            "nice --help reboot",
            "ionice -h reboot",
            "sgdisk -? --zap-all /dev/sda",
            "wipefs --help -a /dev/sda",
            "zfs destroy -r --help tank/home",
            "sudo -u root blkdiscard --dry-run /dev/sda",
            "env -i wipefs -n -a /dev/sda",
            "sudo -u root zfs destroy -n -r tank/home",
            "env -i lvremove --test vg/data",
            "sudo -u root find /etc -false -delete",
            "sudo --chdir /tmp blkdiscard --dry-run /dev/sda",
            "env --chdir /tmp wipefs -n -a /dev/sda",
            "find -E /etc -name '*.bak' -delete",
            "find -d /etc -false -delete",
            "find -f /etc -name '*.bak' -delete",
            "tee /tmp/log <<< '/dev/sda'",
            "shred --help /dev/sda",
            "dd --help of=/dev/sda",
            "nvme format --help /dev/nvme0n1",
            "lvdisplay vg/data",
            "zpool destroy --help",
            "lvremove --help",
            "vgremove --test vg0",
