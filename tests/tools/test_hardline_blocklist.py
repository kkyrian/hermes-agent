...
_HARDLINE_BLOCK = [
    ...
    "command -p dd if=/dev/zero of=/dev/sda",
    "busybox dd if=/dev/zero of=/dev/sda",
    "find /tmp -exec mkfs.ext4 /dev/sda \\;",
    "echo x | xargs dd if=/dev/zero of=/dev/sda",
    "busybox rm -rf /",
    ...
    "find /home/[^x]* -delete",
    "sudo find /etc -name '*' -delete",
    "sudo find /home -type f -delete",
